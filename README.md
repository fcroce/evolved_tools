...
- [Basic functionalities](#basic-functionalities)
    ...
    - [$$et.getBool(variable)](#getBool)
    - [$$et.getInt(variable)](#getInt)
    - [$$et.getFloat(variable)](#getFloat)
    - [$$et.cloneObject(variable)](#cloneObject)
    - [$$et.mergeObjects(variable)](#mergeObjects)
    - [$$et.getObjectLength(variable)](#getObjectLength)
